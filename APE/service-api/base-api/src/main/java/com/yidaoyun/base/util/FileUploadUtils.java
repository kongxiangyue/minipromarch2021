...
public class FileUploadUtils {
     ...
     */
    public static String uploadInputStream(String baseDir, InputStream input)
            throws IOException {
        String extension = MimeTypeUtils.getExtension(MimeTypeUtils.IMAGE_JPG);;
        String fileName = DateUtils.datePath() + "/" + encodingFilename("qrcode") + "." + extension;
        File desc = getAbsoluteFile(baseDir, fileName);
        int index;
